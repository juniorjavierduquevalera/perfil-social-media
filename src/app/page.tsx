...
export default function Home() {
  return (
    <main>
      <div className="container max-w-[1080px] mx-auto p-4 md:p-6 2xl:p-10">
          ...
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
              <ol className="flex items-center gap-2">
                <li>
                  <Link href="/index.html" className="font-medium">
                    Dashboard
                  </Link>
                </li>
          ...
          <div className="overflow-hidden rounded-sm border border-stroke bg-white">
            <div className="relative z-20">
              <Image
                ...
                height={300}
              />
              <div className="absolute bottom-4 right-4 z-10 xsm:bottom-4 xsm:right-4">
                <label
                  htmlFor="cover"
                  className="flex cursor-pointer items-center justify-center gap-2 rounded bg-blue-600 px-4 py-1 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4"
                >
                  <input
                    type="file"
                    name="cover"
            ...
            <div className="px-4 -mt-20 pb-6 text-center lg:pb-8 xl:pb-10">
              <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-36 rounded-full bg-white/30 p-1 sm:h-44 sm:max-w-44 sm:p-3">
                <div className="relative drop-shadow-2">
                  ...
                  <label
                    htmlFor="profile"
                    className="absolute bottom-0 right-0 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-blue-600 text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
                  >
                    <svg
                      className="fill-current"
                      width="14"
              ...
              <div className="mt-4 max-w-[720px] mx-auto">
                <h3 className="mb-1.5 text-2xl font-bold">Junior Duque</h3>
                <p className="font-medium text-gray-600">React Developer</p>
                <div className="mx-auto mb-5 mt-4 grid max-w-96 grid-cols-3 rounded-md border border-stroke py-3 shadow-1">
                  <div className="flex lg:flex-row flex-col items-center justify-center gap-1 border-r border-stroke px-4">
                  ...
                  <div className="flex lg:flex-row flex-col items-center justify-center border-r border-stroke gap-1 px-4">
                ...
                <div className="mx-auto max-w-[720px]">
                  <h4 className="font-medium text-gray-600">About Me</h4>
                  <p className="mt-4 text-sm font-light">
                    I am a developer specializing in web applications with
                    technologies like Next.js and Firebase. I focus on
                    problem-solving, performance optimization, and delivering
                    excellent user experiences. My projects range from
                    leadership management to online product promotion. I am
                    dedicated to continuous learning and adopting new
                    technologies.
                  </p>
                </div>
